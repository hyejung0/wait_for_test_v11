...
Is this cross-reference working? \@ref(tab:tbl-secondary-target-investigate-copy).
...
Below is the 2 by 2 contingency table showing the 1L therapy type (Target or not) and whether the patient had targetable mutation by time zero (Table \@ref(tab:target-therapy-mutation-status-contingency-table-v2)). Based on the above contingency table, there are people who have targetable mutation but still got something else (N=586).:

Table: (\#tab:target-therapy-mutation-status-contingency-table-v2)  
Contingency of X1 vs X2.
```{r target-therapy-mutation-status-contingency-table-v2, results='asis'}
#| echo: false
#| eval: true
#| warning: false
#| message: false
