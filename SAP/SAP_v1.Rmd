...
Patient attrition diagram is shown below.. It shows all exclusion criteria. We excluded all patients who start either the 1L therapy or valid test before time zero, which is advanced diagnosis date. We will explain what valid test means in the next section. 



```{r pt_attrition, echo=FALSE, out.width='70%', fig.cap='Figure XX: Exclusion diagram'}


knitr::include_graphics("patient_attrition_diagram.png")
